...
@property (readonly) BridgeClientPlatformConfigBridgeEnv *bridgeEnv __attribute__((swift_name("bridgeEnv")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PlatformConfigBridgeEnv")))
@interface BridgeClientPlatformConfigBridgeEnv : BridgeClientKotlinEnum<BridgeClientPlatformConfigBridgeEnv *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) BridgeClientPlatformConfigBridgeEnv *production __attribute__((swift_name("production")));
@property (class, readonly) BridgeClientPlatformConfigBridgeEnv *staging __attribute__((swift_name("staging")));
@property (class, readonly) BridgeClientPlatformConfigBridgeEnv *development __attribute__((swift_name("development")));
@property (class, readonly) BridgeClientPlatformConfigBridgeEnv *custom __attribute__((swift_name("custom")));
+ (BridgeClientKotlinArray<BridgeClientPlatformConfigBridgeEnv *> *)values __attribute__((swift_name("values()")));
