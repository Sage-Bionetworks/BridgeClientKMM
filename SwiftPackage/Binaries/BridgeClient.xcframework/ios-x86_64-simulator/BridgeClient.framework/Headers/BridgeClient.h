...
- (instancetype)initWithGuid:(NSString *)guid label:(NSString *)label performanceOrder:(BridgeClientPerformanceOrder *)performanceOrder timeWindowGuids:(NSArray<NSString *> * _Nullable)timeWindowGuids minutesToComplete:(BridgeClientInt * _Nullable)minutesToComplete notifications:(NSArray<BridgeClientNotificationInfo *> * _Nullable)notifications type:(NSString * _Nullable)type __attribute__((swift_name("init(guid:label:performanceOrder:timeWindowGuids:minutesToComplete:notifications:type:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientSessionInfoCompanion *companion __attribute__((swift_name("companion")));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (BridgeClientPerformanceOrder *)component3 __attribute__((swift_name("component3()")));
- (NSArray<NSString *> * _Nullable)component4 __attribute__((swift_name("component4()")));
- (BridgeClientInt * _Nullable)component5 __attribute__((swift_name("component5()")));
- (NSArray<BridgeClientNotificationInfo *> * _Nullable)component6 __attribute__((swift_name("component6()")));
- (NSString * _Nullable)component7 __attribute__((swift_name("component7()")));
- (BridgeClientSessionInfo *)doCopyGuid:(NSString *)guid label:(NSString *)label performanceOrder:(BridgeClientPerformanceOrder *)performanceOrder timeWindowGuids:(NSArray<NSString *> * _Nullable)timeWindowGuids minutesToComplete:(BridgeClientInt * _Nullable)minutesToComplete notifications:(NSArray<BridgeClientNotificationInfo *> * _Nullable)notifications type:(NSString * _Nullable)type __attribute__((swift_name("doCopy(guid:label:performanceOrder:timeWindowGuids:minutesToComplete:notifications:type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *guid __attribute__((swift_name("guid")));
...
@interface BridgeClientIosHttpClient : BridgeClientBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)iosHttpClient __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) BridgeClientIosHttpClient *shared __attribute__((swift_name("shared")));
@property (readonly) BridgeClientKtor_client_coreHttpClient *httpClient __attribute__((swift_name("httpClient")));
@end;
