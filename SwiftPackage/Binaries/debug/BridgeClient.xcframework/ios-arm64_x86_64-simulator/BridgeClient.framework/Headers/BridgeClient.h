...
@property (readonly) NSString * _Nullable startEventId __attribute__((swift_name("startEventId")));
@property NSString *startTime __attribute__((swift_name("startTime")));
...
@property (readonly) BridgeClientScheduleQueries *scheduleQueries __attribute__((swift_name("scheduleQueries")));
@end;
...
- (id<BridgeClientBridgeResourceDatabase>)invokeDriver:(id<BridgeClientRuntimeSqlDriver>)driver JsonDataAdapter:(BridgeClientJsonDataAdapter *)JsonDataAdapter ResourceAdapter:(BridgeClientResourceAdapter *)ResourceAdapter __attribute__((swift_name("invoke(driver:JsonDataAdapter:ResourceAdapter:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("JoinScheduledSessionsAssessments")))
@interface BridgeClientJoinScheduledSessionsAssessments : BridgeClientBase
- (instancetype)initWithInstanceGuid:(NSString *)instanceGuid startDate:(NSString *)startDate endDate:(NSString *)endDate startTime:(NSString *)startTime studyId:(NSString *)studyId sessionJson:(NSString * _Nullable)sessionJson sessionInstanceGuid:(NSString *)sessionInstanceGuid instanceGuid_:(NSString *)instanceGuid_ guid:(NSString *)guid studyId_:(NSString *)studyId_ __attribute__((swift_name("init(instanceGuid:startDate:endDate:startTime:studyId:sessionJson:sessionInstanceGuid:instanceGuid_:guid:studyId_:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSString *)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
- (BridgeClientJoinScheduledSessionsAssessments *)doCopyInstanceGuid:(NSString *)instanceGuid startDate:(NSString *)startDate endDate:(NSString *)endDate startTime:(NSString *)startTime studyId:(NSString *)studyId sessionJson:(NSString * _Nullable)sessionJson sessionInstanceGuid:(NSString *)sessionInstanceGuid instanceGuid_:(NSString *)instanceGuid_ guid:(NSString *)guid studyId_:(NSString *)studyId_ __attribute__((swift_name("doCopy(instanceGuid:startDate:endDate:startTime:studyId:sessionJson:sessionInstanceGuid:instanceGuid_:guid:studyId_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *guid __attribute__((swift_name("guid")));
@property (readonly) NSString *instanceGuid __attribute__((swift_name("instanceGuid")));
@property (readonly) NSString *instanceGuid_ __attribute__((swift_name("instanceGuid_")));
@property (readonly) NSString *sessionInstanceGuid __attribute__((swift_name("sessionInstanceGuid")));
@property (readonly) NSString * _Nullable sessionJson __attribute__((swift_name("sessionJson")));
...
@property (readonly) NSString *studyId_ __attribute__((swift_name("studyId_")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ScheduleQueries")))
@interface BridgeClientScheduleQueries : BridgeClientRuntimeTransacterImpl
- (instancetype)initWithDriver:(id<BridgeClientRuntimeSqlDriver>)driver __attribute__((swift_name("init(driver:)"))) __attribute__((objc_designated_initializer));
- (BridgeClientRuntimeQuery<BridgeClientJoinScheduledSessionsAssessments *> *)JoinScheduledSessionsAssessments __attribute__((swift_name("JoinScheduledSessionsAssessments()")));
- (BridgeClientRuntimeQuery<id> *)JoinScheduledSessionsAssessmentsMapper:(id (^)(NSString *, NSString *, NSString *, NSString *, NSString *, NSString * _Nullable, NSString *, NSString *, NSString *, NSString *))mapper __attribute__((swift_name("JoinScheduledSessionsAssessments(mapper:)")));
- (BridgeClientRuntimeQuery<BridgeClientSessionsForDay *> *)SessionsForDayStartDate:(NSString *)startDate __attribute__((swift_name("SessionsForDay(startDate:)")));
- (BridgeClientRuntimeQuery<id> *)SessionsForDayStartDate:(NSString *)startDate mapper:(id (^)(NSString *, NSString *, NSString *, NSString *, NSString *, NSString * _Nullable, NSString *, NSString *, NSString *, NSString *))mapper __attribute__((swift_name("SessionsForDay(startDate:mapper:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ScheduledAssessments")))
@interface BridgeClientScheduledAssessments : BridgeClientBase
- (instancetype)initWithSessionInstanceGuid:(NSString *)sessionInstanceGuid instanceGuid:(NSString *)instanceGuid guid:(NSString *)guid studyId:(NSString *)studyId __attribute__((swift_name("init(sessionInstanceGuid:instanceGuid:guid:studyId:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (BridgeClientScheduledAssessments *)doCopySessionInstanceGuid:(NSString *)sessionInstanceGuid instanceGuid:(NSString *)instanceGuid guid:(NSString *)guid studyId:(NSString *)studyId __attribute__((swift_name("doCopy(sessionInstanceGuid:instanceGuid:guid:studyId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *guid __attribute__((swift_name("guid")));
...
- (instancetype)initWithInstanceGuid:(NSString *)instanceGuid startDate:(NSString *)startDate endDate:(NSString *)endDate startTime:(NSString *)startTime studyId:(NSString *)studyId sessionJson:(NSString * _Nullable)sessionJson __attribute__((swift_name("init(instanceGuid:startDate:endDate:startTime:studyId:sessionJson:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (BridgeClientScheduledSessions *)doCopyInstanceGuid:(NSString *)instanceGuid startDate:(NSString *)startDate endDate:(NSString *)endDate startTime:(NSString *)startTime studyId:(NSString *)studyId sessionJson:(NSString * _Nullable)sessionJson __attribute__((swift_name("doCopy(instanceGuid:startDate:endDate:startTime:studyId:sessionJson:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *endDate __attribute__((swift_name("endDate")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SessionsForDay")))
@interface BridgeClientSessionsForDay : BridgeClientBase
- (instancetype)initWithInstanceGuid:(NSString *)instanceGuid startDate:(NSString *)startDate endDate:(NSString *)endDate startTime:(NSString *)startTime studyId:(NSString *)studyId sessionJson:(NSString * _Nullable)sessionJson sessionInstanceGuid:(NSString *)sessionInstanceGuid instanceGuid_:(NSString *)instanceGuid_ guid:(NSString *)guid studyId_:(NSString *)studyId_ __attribute__((swift_name("init(instanceGuid:startDate:endDate:startTime:studyId:sessionJson:sessionInstanceGuid:instanceGuid_:guid:studyId_:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component10 __attribute__((swift_name("component10()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSString *)component8 __attribute__((swift_name("component8()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
- (BridgeClientSessionsForDay *)doCopyInstanceGuid:(NSString *)instanceGuid startDate:(NSString *)startDate endDate:(NSString *)endDate startTime:(NSString *)startTime studyId:(NSString *)studyId sessionJson:(NSString * _Nullable)sessionJson sessionInstanceGuid:(NSString *)sessionInstanceGuid instanceGuid_:(NSString *)instanceGuid_ guid:(NSString *)guid studyId_:(NSString *)studyId_ __attribute__((swift_name("doCopy(instanceGuid:startDate:endDate:startTime:studyId:sessionJson:sessionInstanceGuid:instanceGuid_:guid:studyId_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *endDate __attribute__((swift_name("endDate")));
...
- (instancetype)initWithDatabase:(BridgeClientResourceDatabaseHelper *)database backgroundScope:(id<BridgeClientKotlinx_coroutines_coreCoroutineScope>)backgroundScope __attribute__((swift_name("init(database:backgroundScope:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (id<BridgeClientKotlinx_coroutines_coreFlow>)getFutureSessionsStudyId:(NSString *)studyId fromInstant:(BridgeClientKotlinx_datetimeInstant *)fromInstant __attribute__((swift_name("getFutureSessions(studyId:fromInstant:)")));
...
- (id<BridgeClientKotlinx_coroutines_coreFlow>)getStudyBurstScheduleStudyId:(NSString *)studyId userJoinedDate:(BridgeClientKotlinx_datetimeInstant *)userJoinedDate timezone:(BridgeClientKotlinx_datetimeTimeZone *)timezone __attribute__((swift_name("getStudyBurstSchedule(studyId:userJoinedDate:timezone:)")));
...
- (NSArray<BridgeClientScheduledSessionWindow *> *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<BridgeClientScheduledNotification *> *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (instancetype)initWithSchema:(id<BridgeClientRuntimeSqlSchema>)schema name:(NSString *)name maxReaderConnections:(int32_t)maxReaderConnections __attribute__((swift_name("init(schema:name:maxReaderConnections:)"))) __attribute__((objc_designated_initializer));
