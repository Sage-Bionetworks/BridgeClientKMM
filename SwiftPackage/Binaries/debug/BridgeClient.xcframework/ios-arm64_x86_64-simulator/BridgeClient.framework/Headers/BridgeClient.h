...
- (instancetype)initWithSessions:(NSArray<NSArray<BridgeClientNativeScheduledSessionWindow *> *> *)sessions __attribute__((swift_name("init(sessions:)"))) __attribute__((objc_designated_initializer));
- (NSArray<NSArray<BridgeClientNativeScheduledSessionWindow *> *> *)component1 __attribute__((swift_name("component1()")));
- (BridgeClientNativeStudyBurst *)doCopySessions:(NSArray<NSArray<BridgeClientNativeScheduledSessionWindow *> *> *)sessions __attribute__((swift_name("doCopy(sessions:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<NSArray<BridgeClientNativeScheduledSessionWindow *> *> *sessions __attribute__((swift_name("sessions")));
@end;
...
- (instancetype)initWithStudyId:(NSString *)studyId viewUpdated:(void (^)(BridgeClientNativeStudyBurstSchedule * _Nullable, NSString * _Nullable))viewUpdated scheduleMutator:(id<BridgeClientParticipantScheduleMutator> _Nullable)scheduleMutator updateFailed:(void (^ _Nullable)(void))updateFailed __attribute__((swift_name("init(studyId:viewUpdated:scheduleMutator:updateFailed:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithStudyId:(NSString *)studyId __attribute__((swift_name("init(studyId:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
...
- (instancetype)initWithSessions:(NSArray<NSArray<BridgeClientScheduledSessionWindow *> *> *)sessions __attribute__((swift_name("init(sessions:)"))) __attribute__((objc_designated_initializer));
- (NSArray<NSArray<BridgeClientScheduledSessionWindow *> *> *)component1 __attribute__((swift_name("component1()")));
- (BridgeClientStudyBurst *)doCopySessions:(NSArray<NSArray<BridgeClientScheduledSessionWindow *> *> *)sessions __attribute__((swift_name("doCopy(sessions:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<NSArray<BridgeClientScheduledSessionWindow *> *> *sessions __attribute__((swift_name("sessions")));
@end;
