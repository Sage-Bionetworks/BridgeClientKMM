...
@interface BridgeClientUploadFile : BridgeClientBase
- (instancetype)initWithFilePath:(NSString *)filePath contentType:(NSString *)contentType fileLength:(int64_t)fileLength md5Hash:(NSString *)md5Hash encrypted:(BOOL)encrypted metadata:(BridgeClientUploadMetadata * _Nullable)metadata sessionExpires:(BridgeClientKotlinx_datetimeInstant * _Nullable)sessionExpires __attribute__((swift_name("init(filePath:contentType:fileLength:md5Hash:encrypted:metadata:sessionExpires:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) BridgeClientUploadFileCompanion *companion __attribute__((swift_name("companion")));
- (BridgeClientUploadFile *)doCopyFilePath:(NSString *)filePath contentType:(NSString *)contentType fileLength:(int64_t)fileLength md5Hash:(NSString *)md5Hash encrypted:(BOOL)encrypted metadata:(BridgeClientUploadMetadata * _Nullable)metadata sessionExpires:(BridgeClientKotlinx_datetimeInstant * _Nullable)sessionExpires __attribute__((swift_name("doCopy(filePath:contentType:fileLength:md5Hash:encrypted:metadata:sessionExpires:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *md5Hash __attribute__((swift_name("md5Hash")));
@property (readonly) BridgeClientUploadMetadata * _Nullable metadata __attribute__((swift_name("metadata")));
@property (readonly) BridgeClientKotlinx_datetimeInstant * _Nullable sessionExpires __attribute__((swift_name("sessionExpires")));
@end
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (NSDictionary<NSString *, NSString *> *)toStringMap __attribute__((swift_name("toStringMap()")));
