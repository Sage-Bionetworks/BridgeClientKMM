...
- (instancetype)initWithStudyId:(NSString *)studyId __attribute__((swift_name("init(studyId:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (void)observeTodayScheduleIsNewLogin:(BOOL)isNewLogin __attribute__((swift_name("observeTodaySchedule(isNewLogin:)")));
- (void)observeTodayScheduleIsNewLogin:(BOOL)isNewLogin scheduleMutator:(id<BridgeClientParticipantScheduleMutator> _Nullable)scheduleMutator __attribute__((swift_name("observeTodaySchedule(isNewLogin:scheduleMutator:)")));
...
@property (readonly) id<BridgeClientScheduleQueries> scheduleQueries __attribute__((swift_name("scheduleQueries")));
@end;
...
@protocol BridgeClientScheduleQueries <BridgeClientRuntimeTransacter>
@required
