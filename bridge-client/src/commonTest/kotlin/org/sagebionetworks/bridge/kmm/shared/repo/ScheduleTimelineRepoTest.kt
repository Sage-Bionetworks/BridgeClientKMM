...
//                assertTrue(session2.isCompleted)
    ...
    {
       "createdOn":"2023-03-17T14:13:16.647-07:00",
       "clientTimeZone":"America/Los_Angeles",
       "dateRange":{
       ...
       "schedule":[
          {
             "instanceGuid":"miS94RKSZ2ltH63pf2rpPg",
             "refGuid":"s_hwLrVzjUVy9RrMoNWmgOJt",
             "startEventId":"timeline_retrieved",
             "startDate":"2023-03-17",
             "endDate":"2023-03-31",
             "startTime":"08:00",
             ...
             "assessments":[
                {
                   "refKey":"bfa0e5e7bfa0e5e7",
                   "instanceGuid":"K2zxSOpGP9U3IUKuPUTxEA",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"38ac318138ac3181",
                   "instanceGuid":"Lfr6pcKoDIKGrI_Bz6WBSA",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"d2858af3d2858af3",
                   "instanceGuid":"8sdT-9bPGNVAXy6jy00_pQ",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"80b6884080b68840",
                   "instanceGuid":"CG6q86EhQU9I1ltvwqxt4A",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"75a06a4d75a06a4d",
                ...
                {
                   "refKey":"2049c6692049c669",
                   "instanceGuid":"Y3G30jU9bz8veOw77cg4hg",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"28cfc19128cfc191",
                   "instanceGuid":"lR6NFjYcRKQvPaMUSkuZjA",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"149597ac149597ac",
                   "instanceGuid":"AIalj73gciRpzp3wfyc15A",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"a17c6070a17c6070",
                   "instanceGuid":"qKaTUXB-3xtfbDo8KFiSUA",
                   "type":"ScheduledAssessment"
                }
             ],
             "type":"ScheduledSession"
          ...
          {
             "instanceGuid":"IQujEA8mRVOwb3CfQKsrZw",
             "refGuid":"niejwYl9RyxWPPxWK8p_IjQr",
             "startEventId":"custom:6months",
             ...
             "assessments":[
                {
                   "refKey":"bfa0e5e7bfa0e5e7",
                   "instanceGuid":"L9xqOiYoB-ZOdPgBtoaiXw",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"38ac318138ac3181",
                   "instanceGuid":"HjKeqobAF4drrVm9W8vflw",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"d2858af3d2858af3",
                   "instanceGuid":"1Zxk0G5My8RR5U6eWBGTNQ",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"80b6884080b68840",
                   "instanceGuid":"OCXi2XgogF305a_Wesvdqg",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"75a06a4d75a06a4d",
                   "instanceGuid":"2eRH6as6ORUxx-In_UBuAA",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"2049c6692049c669",
                   "instanceGuid":"d8vLNiwkUMc-cl4Y0uYT6g",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"28cfc19128cfc191",
                   "instanceGuid":"ERX1tlxnmGa2zG1PyuETvg",
                   "type":"ScheduledAssessment"
                }
             ],
             "type":"ScheduledSession"
          ...
          {
             "instanceGuid":"cwdPIpYi6U5rjuFxtOCPkw",
             "refGuid":"9zpVE_R1sANdBZomAcn6w2PN",
             "startEventId":"custom:12months",
             ...
             "assessments":[
                {
                   "refKey":"bfa0e5e7bfa0e5e7",
                   "instanceGuid":"E1_GFUi2sSy4Gc55adrD5g",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"38ac318138ac3181",
                   "instanceGuid":"N-7ARXPrkOFYCYWFEJGBtg",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"d2858af3d2858af3",
                   "instanceGuid":"t4_DVE_iUxxvTKf_uWWwYw",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"80b6884080b68840",
                   "instanceGuid":"RvcmGd4ZP10G2D9UZW8hEw",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"75a06a4d75a06a4d",
                   "instanceGuid":"-g8Rz20b_vdU0_gJXCCmNQ",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"2049c6692049c669",
                   "instanceGuid":"aBunF4jsFWQS8tBAe5zn1Q",
                   "type":"ScheduledAssessment"
                },
                {
                   "refKey":"28cfc19128cfc191",
                   "instanceGuid":"q0b8_opw5onqiqQzl5BNFw",
                   "type":"ScheduledAssessment"
                }
             ],
             "type":"ScheduledSession"
             ...
             "notifications":[
                {
                   ...
                   "message":{
                      ...
                      "message":"Please finish activities in one sitting.",
                      "type":"NotificationMessage"
                   },
                   "type":"NotificationInfo"
                },
                {
                   ...
                   "message":{
                      "lang":"en",
                      "subject":"Please complete activities if not done",
                      "message":"Complete activities in one sitting.",
                      "type":"NotificationMessage"
                   },
                   "type":"NotificationInfo"
                }
       ...
       "eventTimestamps":{
          "custom:6months":"2023-09-17T16:10:40.000Z",
          "timeline_retrieved":"2023-03-17T12:45:38.621Z",
          "custom:12months":"2024-03-18T16:21:12.000Z"
       },
       "type":"ParticipantSchedule"
    }
    """.trimIndent()
    ...
    fun testBMC446AssessmentOrder() {
        ...
        runTest {
            ...
            val todayInstant = Instant.parse("2023-03-18T13:45:38.621Z")
            // get sessions using call that would be used on iOS
            val resourceResult = repo.getSessionsForDay(studyId, todayInstant, alwaysIncludeNextDay = true)
                .firstOrNull { it is ResourceResult.Success }
            assertTrue(resourceResult is ResourceResult.Success)
