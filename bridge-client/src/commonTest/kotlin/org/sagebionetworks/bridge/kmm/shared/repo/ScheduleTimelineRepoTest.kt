...
//                assertTrue(session2.isCompleted)
            ...
            // Next day is shown b/c alwaysIncludeNextDay = true
    ...
    fun testScheduledSessionsDay3WithCompletion() {
        runTest {
            val studyId = "testScheduledSessionsDay3WithCompletion"
            val eventTimeStamp = Clock.System.now().minus(3, DateTimeUnit.DAY, TimeZone.currentSystemDefault())
    ...
    fun testBMC337Notifications() {
        ...
        runTest {
            ...
            val resourceResult = repo.getSessionsForDay(studyId, todayInstant, alwaysIncludeNextDay = true)
                .firstOrNull { it is ResourceResult.Success }
            assertTrue(resourceResult is ResourceResult.Success)
    ...
    fun test_createStudyBurst() {
        runTest {
            ...
            val resourceResult = repo.getStudyBurstSchedule(studyId).firstOrNull { it is ResourceResult.Success }
    ...
    fun StudyBurst.startDate(): LocalDate {
        return this.sessions.first().startDateTime.date
    }

    fun StudyBurst.endDate(): LocalDate {
        return this.sessions.last().startDateTime.date
    }

    val bmc446TimelineJson = """
    {"createdOn":"2023-03-17T14:13:16.647-07:00","clientTimeZone":"America/Los_Angeles","dateRange":{"startDate":"2023-03-17","endDate":"2024-04-15","type":"DateRange"},"schedule":[{"instanceGuid":"miS94RKSZ2ltH63pf2rpPg","refGuid":"s_hwLrVzjUVy9RrMoNWmgOJt","startEventId":"timeline_retrieved","startDate":"2023-03-17","endDate":"2023-03-31","startTime":"08:00","expiration":"P2W","assessments":[{"refKey":"bfa0e5e7bfa0e5e7","instanceGuid":"K2zxSOpGP9U3IUKuPUTxEA","type":"ScheduledAssessment"},{"refKey":"38ac318138ac3181","instanceGuid":"Lfr6pcKoDIKGrI_Bz6WBSA","type":"ScheduledAssessment"},{"refKey":"d2858af3d2858af3","instanceGuid":"8sdT-9bPGNVAXy6jy00_pQ","type":"ScheduledAssessment"},{"refKey":"80b6884080b68840","instanceGuid":"CG6q86EhQU9I1ltvwqxt4A","type":"ScheduledAssessment"},{"refKey":"75a06a4d75a06a4d","instanceGuid":"AVB8kvMHvZOrZMIxjVwo4Q","type":"ScheduledAssessment"},{"refKey":"2049c6692049c669","instanceGuid":"Y3G30jU9bz8veOw77cg4hg","type":"ScheduledAssessment"},{"refKey":"28cfc19128cfc191","instanceGuid":"lR6NFjYcRKQvPaMUSkuZjA","type":"ScheduledAssessment"},{"refKey":"149597ac149597ac","instanceGuid":"AIalj73gciRpzp3wfyc15A","type":"ScheduledAssessment"},{"refKey":"a17c6070a17c6070","instanceGuid":"qKaTUXB-3xtfbDo8KFiSUA","type":"ScheduledAssessment"}],"type":"ScheduledSession"},{"instanceGuid":"IQujEA8mRVOwb3CfQKsrZw","refGuid":"niejwYl9RyxWPPxWK8p_IjQr","startEventId":"custom:6months","startDate":"2023-09-17","endDate":"2023-10-15","startTime":"08:00","expiration":"P4W","assessments":[{"refKey":"bfa0e5e7bfa0e5e7","instanceGuid":"L9xqOiYoB-ZOdPgBtoaiXw","type":"ScheduledAssessment"},{"refKey":"38ac318138ac3181","instanceGuid":"HjKeqobAF4drrVm9W8vflw","type":"ScheduledAssessment"},{"refKey":"d2858af3d2858af3","instanceGuid":"1Zxk0G5My8RR5U6eWBGTNQ","type":"ScheduledAssessment"},{"refKey":"80b6884080b68840","instanceGuid":"OCXi2XgogF305a_Wesvdqg","type":"ScheduledAssessment"},{"refKey":"75a06a4d75a06a4d","instanceGuid":"2eRH6as6ORUxx-In_UBuAA","type":"ScheduledAssessment"},{"refKey":"2049c6692049c669","instanceGuid":"d8vLNiwkUMc-cl4Y0uYT6g","type":"ScheduledAssessment"},{"refKey":"28cfc19128cfc191","instanceGuid":"ERX1tlxnmGa2zG1PyuETvg","type":"ScheduledAssessment"}],"type":"ScheduledSession"},{"instanceGuid":"cwdPIpYi6U5rjuFxtOCPkw","refGuid":"9zpVE_R1sANdBZomAcn6w2PN","startEventId":"custom:12months","startDate":"2024-03-18","endDate":"2024-04-15","startTime":"08:00","expiration":"P4W","assessments":[{"refKey":"bfa0e5e7bfa0e5e7","instanceGuid":"E1_GFUi2sSy4Gc55adrD5g","type":"ScheduledAssessment"},{"refKey":"38ac318138ac3181","instanceGuid":"N-7ARXPrkOFYCYWFEJGBtg","type":"ScheduledAssessment"},{"refKey":"d2858af3d2858af3","instanceGuid":"t4_DVE_iUxxvTKf_uWWwYw","type":"ScheduledAssessment"},{"refKey":"80b6884080b68840","instanceGuid":"RvcmGd4ZP10G2D9UZW8hEw","type":"ScheduledAssessment"},{"refKey":"75a06a4d75a06a4d","instanceGuid":"-g8Rz20b_vdU0_gJXCCmNQ","type":"ScheduledAssessment"},{"refKey":"2049c6692049c669","instanceGuid":"aBunF4jsFWQS8tBAe5zn1Q","type":"ScheduledAssessment"},{"refKey":"28cfc19128cfc191","instanceGuid":"q0b8_opw5onqiqQzl5BNFw","type":"ScheduledAssessment"}],"type":"ScheduledSession"}],"sessions":[{"guid":"s_hwLrVzjUVy9RrMoNWmgOJt","label":"Baseline","performanceOrder":"sequential","minutesToComplete":36,"notifications":[{"notifyAt":"after_window_start","allowSnooze":false,"message":{"lang":"en","subject":"New Activities are Live!","message":"Please finish activities in one sitting.","type":"NotificationMessage"},"type":"NotificationInfo"},{"notifyAt":"after_window_start","offset":"P3DT30M","interval":"P4D","allowSnooze":false,"message":{"lang":"en","subject":"Please complete activities if not done","message":"Complete activities in one sitting.","type":"NotificationMessage"},"type":"NotificationInfo"}],"type":"SessionInfo"},{"guid":"niejwYl9RyxWPPxWK8p_IjQr","label":"Month 6","performanceOrder":"sequential","minutesToComplete":30,"notifications":[{"notifyAt":"after_window_start","allowSnooze":false,"message":{"lang":"en","subject":"New Activities are Live!","message":"Please finish activities in one sitting.","type":"NotificationMessage"},"type":"NotificationInfo"},{"notifyAt":"after_window_start","offset":"P3DT30M","interval":"P7D","allowSnooze":false,"message":{"lang":"en","subject":"Please complete activities if not done ","message":"Complete activities in one sitting.","type":"NotificationMessage"},"type":"NotificationInfo"}],"type":"SessionInfo"},{"guid":"9zpVE_R1sANdBZomAcn6w2PN","label":"Month 12","performanceOrder":"sequential","minutesToComplete":30,"notifications":[{"notifyAt":"after_window_start","allowSnooze":false,"message":{"lang":"en","subject":"New Activities are Live!","message":"Please finish activities in one sitting.","type":"NotificationMessage"},"type":"NotificationInfo"},{"notifyAt":"after_window_start","offset":"P3DT30M","interval":"P7D","allowSnooze":false,"message":{"lang":"en","subject":"Please complete activities if not done","message":"Complete activities in one sitting.","type":"NotificationMessage"},"type":"NotificationInfo"}],"type":"SessionInfo"}],"assessments":[{"key":"75a06a4d75a06a4d","guid":"P6_85NRS0ak6fil-J1SKvWJT","appId":"shared","identifier":"memory-for-sequences","revision":7,"label":"Sequences","minutesToComplete":5,"colorScheme":{"background":"#FFFFFF","foreground":"#ABBCE8","activated":"#ABBCE8","inactivated":"#C7D0E6","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/P6_85NRS0ak6fil-J1SKvWJT/config","type":"AssessmentInfo"},{"key":"80b6884080b68840","guid":"z0iTUF87JPqqklAOUW4fBwJt","appId":"shared","identifier":"dccs","revision":6,"label":"Shape-Color Sorting","minutesToComplete":3,"colorScheme":{"background":"#FFFFFF","foreground":"#F4B795","activated":"#F4B795","inactivated":"#FCEDE4","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/z0iTUF87JPqqklAOUW4fBwJt/config","type":"AssessmentInfo"},{"key":"d2858af3d2858af3","guid":"HL8480_09Rixw87Yct2nwQpr","appId":"shared","identifier":"flanker","revision":5,"label":"Arrow Matching","minutesToComplete":3,"colorScheme":{"background":"#FFFFFF","foreground":"#F4B795","activated":"#F4B795","inactivated":"#FCEDE4","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/HL8480_09Rixw87Yct2nwQpr/config","type":"AssessmentInfo"},{"key":"bfa0e5e7bfa0e5e7","guid":"3GtZ6s5iAcRNi9LmRx98XtKm","appId":"shared","identifier":"psm","revision":6,"label":"Arranging Pictures","minutesToComplete":5,"colorScheme":{"background":"#FFFFFF","foreground":"#CCE5D5","activated":"#CCE5D5","inactivated":"#D8E4DC","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/3GtZ6s5iAcRNi9LmRx98XtKm/config","type":"AssessmentInfo"},{"key":"a17c6070a17c6070","guid":"NTw7c8qMcQyesehjpampZeTz","appId":"shared","identifier":"vocabulary","revision":5,"label":"Word Meaning","minutesToComplete":2,"colorScheme":{"background":"#FFFFFF","foreground":"#95CFF4","activated":"#95CFF4","inactivated":"#BCD9EC","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/NTw7c8qMcQyesehjpampZeTz/config","type":"AssessmentInfo"},{"key":"2049c6692049c669","guid":"jRyhrUvjKn5cEPPG_OBmQRLW","appId":"shared","identifier":"number-match","revision":4,"label":"Number-Symbol Match","minutesToComplete":2,"colorScheme":{"background":"#FFFFFF","foreground":"#D2CBE8","activated":"#D2CBE8","inactivated":"#DBD7E6","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/jRyhrUvjKn5cEPPG_OBmQRLW/config","type":"AssessmentInfo"},{"key":"28cfc19128cfc191","guid":"GuiBNp8_SInXtKJvC2cvb46O","appId":"shared","identifier":"fnameb","revision":5,"label":"Faces & Names B","minutesToComplete":6,"colorScheme":{"background":"#FFFFFF","foreground":"#CCE5D5","activated":"#CCE5D5","inactivated":"#D8E4DC","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/GuiBNp8_SInXtKJvC2cvb46O/config","type":"AssessmentInfo"},{"key":"38ac318138ac3181","guid":"AGzr7HtHfVa7FSAFuBZ4pBnO","appId":"shared","identifier":"fnamea","revision":5,"label":"Faces & Names 1A","minutesToComplete":6,"colorScheme":{"background":"#FFFFFF","foreground":"#CCE5D5","activated":"#CCE5D5","inactivated":"#D8E4DC","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/AGzr7HtHfVa7FSAFuBZ4pBnO/config","type":"AssessmentInfo"},{"key":"149597ac149597ac","guid":"v0a2lR0umI_-EypGK2R5bX49","appId":"shared","identifier":"spelling","revision":5,"label":"Spelling","minutesToComplete":4,"colorScheme":{"background":"#FFFFFF","foreground":"#95CFF4","activated":"#95CFF4","inactivated":"#BCD9EC","type":"ColorScheme"},"configUrl":"https://ws.sagebridge.org/v1/sharedassessments/v0a2lR0umI_-EypGK2R5bX49/config","type":"AssessmentInfo"}],"studyBursts":[],"eventTimestamps":{"custom:6months":"2023-09-17T16:10:40.000Z","timeline_retrieved":"2023-03-17T12:45:38.621Z","custom:12months":"2024-03-18T16:21:12.000Z"},"type":"ParticipantSchedule"}
    """.trimIndent()
    ...
    fun testBMC446AssessmentOrder() {
        ...
        // view (iOS) is not the expected order from the server.
        runTest {

            val studyId = "jfxqpk"
            val eventTimeStamp = Instant.parse("2023-03-17T12:45:38.621Z")
            val repo = getTestScheduleTimelineRepo(
                timeStamp = eventTimeStamp,
                timelineJson = bmc446TimelineJson)
            val todayInstant = Instant.parse("2023-03-17T13:45:38.621Z")
            // get sessions using call that would be used on iOS
            val resourceResult = repo.getSessionsForDay(studyId, todayInstant, alwaysIncludeNextDay = true)
                .firstOrNull { it is ResourceResult.Success }
            assertTrue(resourceResult is ResourceResult.Success)
            ...
            assertEquals(2, sessionList.size)
            val session1 = sessionList[0]
            val assessments = session1.assessments.map {
                it.assessmentInfo.identifier
            }
